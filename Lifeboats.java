...
import java.util.Scanner;
	...
	{		
		public static void main(String[] args) 
		{
			...
			// Case 1: Total capacity of Lifeboats is greater than or equal to the number of people on the ship
			if (totalMaxCapacityofLifeboats > totalPeopleOnShip)
			{
				...
				// Output the results
				System.out.println("The minimum number of lifeboats required to carry all the people = " + minLifeBoatsRequired);
			...
			// Case 2: Total capacity of Lifeboats is less than the number of people on the ship
			else if (totalMaxCapacityofLifeboats < totalPeopleOnShip) 
			{
				...
				// Calculate the percentage of people rescued type casting int to double for getting decimal values and store in double data type variable
				...
				// Output the results
				System.out.println("The minimum number of lifeboats required to carry all the people = " + minLifeBoatsRequired);
				System.out.println("The number of people that would be rescued if the available lifeboats were filled = " + totalMaxCapacityofLifeboats);
				System.out.printf("The percentage of people that would be rescued if the available lifeboats were filled = %.2f%%\n", totalPeopleRescuedPercent);
			...
			// Case 2: Total capacity of Lifeboats is equal to the number of people on the ship
			else
			{
				
				// Calculate the minimum number of Lifeboats required (even though it would not be enough)	
				minLifeBoatsRequired = totalPeopleOnShip/maxCapacityofALifeboat;
